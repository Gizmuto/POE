...
public class eliminarCurso_vista extends javax.swing.JFrame {

    public eliminarCurso_vista() {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnProfesores2.setText("ELIMINAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(eliminarCurso_vista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new eliminarCurso_vista().setVisible(true);
            }
        });
    }
